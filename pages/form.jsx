            ...
            {step === 2 && (
                <div>
                    ...
                    {defaultCategories.map((category) => (
                        <div key={category} style={{ marginBottom: '10px', display: 'flex', gap: 20, alignItems: 'center' }}>
                            <label style={{ display: 'block', marginBottom: '5px', width: 100 }}>{category}</label>
                            <select
                                ...
                                style={{
                                    ...
                                    borderRadius: '5px',
                                    border: '1px solid #ccc',
                                    backgroundColor: getBackgroundColor(categories[category]?.level),
                                }}
                            >
